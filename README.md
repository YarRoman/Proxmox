...
```yaml
 bash -c "$(wget -qLO - https://github.com/YarRoman/Proxmox/raw/feature/insternet_checking_error/ct/emqx-v4.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  1GB RAM - 4GB Storage - 2vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/YarRoman/Proxmox/raw/feature/insternet_checking_error/ct/postgresql-v4.sh)"
```
